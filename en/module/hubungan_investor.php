<?php
    ...
    $profile = mysql_query("SELECT sub_title, description, sub_title_english, description_english, gambar, tipe, id_tentang_kami, kategori, child, banner, slug, banner_mobile FROM tabel_tentang_kami WHERE slug_english = '$slug'");
				...
				<ul class="list-unstyled main-menu__contact-list set-m10">
					<li>
						<div class="language-menu">
							<a href="<?php echo "$nama_folder/hubungan_investor/$list_profile[slug]";?>" class="language-btn text-12">INDONESIA</a>
							<div class="text-white set-line">|</div>
							<a href="<?php echo "$nama_folder/en/hubungan_investor/$slug";?>" class="language-btn text-12 active">ENGLISH</a>
						</div>
					</li>
				</ul>
            ...
            <div class="row mb-5">
                <div class="col-xl-4">
                    <div class="service-details__services-box">
                        <h3 class="service-details__services-title">Investor Relations</h3>
                        ...
                        if($list_profile['kategori'] != 'child'){
                            ...
                            ?>
                            <li <?php echo $aktif;?>><a href="<?php echo "$nama_website/hubungan_investor/$list_menu_keberlanjutan[slug_english]";?>"><?php echo "$list_menu_keberlanjutan[sub_title_english]";?> <?php echo $span;?></a></li>
                            <?php
                             if($list_menu_keberlanjutan['id_tentang_kami'] == $list_profile['id_tentang_kami']){
                                 ...
                                 {
                                 ?>  
                                 <li><a href="<?php echo "$nama_website/hubungan_investor/$list_menu_keberlanjutan_child[slug_english]";?>"><?php echo $list_menu_keberlanjutan_child['sub_title_english'];?></a></li>
                             <?php
                                 }
                             }
                             ?>
                        ...
                        ?>
                            <li <?php echo $aktif;?>><a href="<?php echo "$nama_website/hubungan_investor/$menu_keberlanjutan_parent2[slug_english]";?>"><?php echo "$menu_keberlanjutan_parent2[sub_title_english]";?> <span class='icon-angle-right'></span></a></li>
                                    ...
                                    <div class="col-xl-12 col-lg-7">
                                        <div class="blog-details__left">
                                            ...
                                            <div class="blog-details__content mb-3">
                                                ...
                                                <?php
                                                $keanggotaan = mysql_query("SELECT id_laporan_tahunan, gambar, title, title_english, file_dokumen FROM tabel_laporan_tahunan WHERE status = '2'");
                                                while ($list_keanggotaan = mysql_fetch_array($keanggotaan))
                                                {
                                                ?>
                                                    <div class="col-lg-4 col-6 mb-5">
                                                        ...
                                                        <div class="text-center line-height22 mb-2"><?php echo "$list_keanggotaan[title_english]";?></div>
                                                        <div class="text-center flex-center">
                                                            <a href="<?php echo "$nama_folder/dokumen/$list_keanggotaan[file_dokumen]";?>"
                                                                ...
                                                                <div class="d-flex font-14">
                                                                    ...
                                                                    <div class="align-content-center">Download Report</div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
