<?php
	...
	$berita = mysql_query("SELECT * FROM tabel_berita where status = '2' AND id_berita = '$id' AND slug_english = '$slug'");
            ...
            <div class="main-menu__top">
                <div class="main-menu__top-inner">
                    <ul class="list-unstyled main-menu__contact-list set-m10">
                        ...
                        <!--        <a href="<?php echo "$nama_folder/read/$id/$list_berita[slug]";?>" class="language-btn">INA</a>-->
                        <!--        <a href="<?php echo "$nama_website/read/$id/$slug";?>" class="language-btn active ">ENG</a>-->
                        <!--    </div>-->
                        <!--</li>-->
                        
                        <li>
    						<div class="language-menu">
    							<a href="<?php echo "$nama_folder/read/$id/$list_berita[slug]";?>" class="language-btn text-12">INDONESIA</a>
    							<div class="text-white set-line">|</div>
    							<a href="<?php echo "$nama_website/read/$id/$slug";?>" class="language-btn text-12 active">ENGLISH</a>
    						</div>
    					</li>
                    </ul>
        ...
        <section class="page-header" style="width: 100%; overflow: hidden;">
            ...
            <div class="container">
                <div class="page-header__inner">
                    <h3><?php echo "$list_berita[title_english]";?></h3>
                    <div class="thm-breadcrumb__inner">
                        <ul class="thm-breadcrumb list-unstyled">
                            <li><a href="<?php echo "$nama_folder/en";?>">Home</a></li>
                            <li><span class="icon-angle-right"></span></li>
                            <li><a href="<?php echo "$nama_folder/en/news";?>">Berita & Kegiatan</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="blog-details__left">
                            ...
                            <div class="blog-details__content">
                                ...
                                <h3 class="blog-details__title">
                                    <?php echo "$list_berita[title_english]";?>
                                </h3>
                                <?php echo "$list_berita[content_english]";?><br>

                                <a href="<?php echo "$list_berita[sumber_artikel]";?>" target="_blank"><p>Source :   <?php echo "$list_berita[sumber_artikel]";?></p></a>
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="sidebar">
                            ...
                            <div class="sidebar__single sidebar__post">
                                <h3 class="sidebar__title">News & Other Activities</h3>
                                ...
                                while ($list_berita_other = mysql_fetch_array($berita_other))
                                {
                                    ...
                                    $judul = limitWord($list_berita_other['title_english'],8);
                                ...
                                ?>
                                    <li>
                                        ...
                                        <div class="sidebar__post-content">
                                            ...
                                            <h3>
                                                <a href="<?php echo "$nama_website/read/$list_berita_other[id_berita]/$list_berita_other[slug_english]";?>"><?php echo "$judul...";?></a>
                                            </h3>
                                        </div>
                                    </li>
                                <?php
