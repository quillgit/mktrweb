		...
		<div class="main-menu__top">
			<div class="main-menu__top-inner">
				<ul class="list-unstyled main-menu__contact-list set-m10">
					...
					<!--		<a href="<?php echo "$nama_folder/penghargaan";?>" class="language-btn">INA</a>-->
					<!--		<a href="<?php echo "$nama_folder/en/penghargaan";?>" class="language-btn active">ENG</a>-->
					<!--	</div>-->
					<!--</li>-->
					
					<li>
						<div class="language-menu">
							<a href="<?php echo "$nama_folder/penghargaan";?>" class="language-btn text-12">INDONESIA</a>
							<div class="text-white set-line">|</div>
							<a href="<?php echo "$nama_folder/en/penghargaan";?>" class="language-btn text-12 active">ENGLISH</a>
						</div>
					</li>
				</ul>
            ...
            <div class="row mb-5">
                <div class="col-xl-4">
                    <div class="service-details__services-box">
                        ...
                        <ul class="service-details__services-list list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo "$nama_website/penghargaan";?>">Awards & Recognition</a></li>
                ...
                <div class="col-xl-8">
                    <section class="shop-details-page1">
                        <div class="container">
                            <?php
                            $penghargaan = mysql_query("SELECT title, title_english, content, content_english, gambar, link FROM tabel_penghargaan");
                            while ($list_penghargaan = mysql_fetch_array($penghargaan))
                            {
                            ?>
                                <div class="row mb-5">
                                    ...
                                    <div class="col-xl-5">
                                        <div class="shop-details-page1__img">
                                            <div class="shop-details-page1__img-inner">
                                                <a data-fslightbox="gallery" href="<?php echo "$nama_folder";?>/images/penghargaan/<?php echo "$list_penghargaan[gambar]";?>">
                                                    <img src="<?php echo "$nama_folder";?>/images/penghargaan/<?php echo "$list_penghargaan[gambar]";?>" alt="" title="KLIK GAMBAR UNTUK LEBIH KELAS">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-7">
                                        <div class="shop-details-page1__content">
                                            <div class="shop-details-page1__title">
                                                <h6>Awards & Recognition</h6>
                                                <h2><?php echo "$list_penghargaan[title_english]";?>
                                                </h2>
                                            </div>
                                            <div class="shop-details-page1__text">
                                                <?php echo "$list_penghargaan[content_english]";?>
                                            </div>
                                        </div>
                                    </div>
