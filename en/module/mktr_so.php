<?php
	...
	if($rowberita > 0){
        ...
        if($list_berita['kategori'] == "dewan_komisaris"){
            $titlenya = "Board of Commissioner";
            $linknya = "dewan_komisaris";
        }else{
            $titlenya = "Board of Directors";
            $linknya = "direksi";
        }
    ?>
				...
				<ul class="list-unstyled main-menu__contact-list set-m10">
					<li>
                        <div class="language-menu">
                            <a href="<?php echo "$nama_folder/mktr_so/$slug";?>" class="language-btn text-12">INDONESIA</a>
                            <div class="text-white set-line">|</div>
                            <a href="<?php echo "$nama_folder/en/mktr_so/$slug";?>" class="language-btn text-12 active">ENGLISH</a>
                        </div>
                    </li>
				</ul>
            ...
            <div class="page-header__inner">
                ...
                <div class="thm-breadcrumb__inner">
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li><span class="icon-angle-right"></span></li>
                        <li><a href="<?php echo "$nama_website/$linknya";?>"><?php echo $titlenya;?></a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="team-details__right mt-5">
                            ...
                            <p class="team-details__sub-title" id="team-role"><?php echo "$list_berita[sub_title_english]";?></p>
                            <?php echo "$list_berita[description_english]";?>
                        </div>
                    </div>
                </div>
            </div>
