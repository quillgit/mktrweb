<?php
    ...
    $profile = mysql_query("SELECT sub_title, description, sub_title_english, description_english, gambar, banner FROM tabel_about_us WHERE id_about_us = '5'");
				...
				<ul class="list-unstyled main-menu__contact-list set-m10">
					<li>
						<div class="language-menu">
							<a href="<?php echo "$nama_folder/struktur_group";?>" class="language-btn text-12">INDONESIA</a>
							<div class="text-white set-line">|</div>
							<a href="<?php echo "$nama_folder/en/struktur_group";?>" class="language-btn text-12 active">ENGLISH</a>
						</div>
					</li>
				</ul>
                ...
                <div class="col-xl-4">
                    <div class="service-details__services-box">
                        ...
                        <ul class="service-details__services-list list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo "$nama_website/struktur_group";?>">Group Structure</a></li>
