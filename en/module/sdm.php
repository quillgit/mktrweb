<?php
    ...
    $profile = mysql_query("SELECT sub_title, description, sub_title_english, description_english, gambar, tipe, id_sumber_daya, banner, slug, banner_mobile FROM tabel_sumber_daya WHERE slug_english = '$slug'");
		...
		<div class="main-menu__top">
			<div class="main-menu__top-inner">
				<ul class="list-unstyled main-menu__contact-list set-m10">
					...
					<!--		<a href="<?php echo "$nama_folder/sdm/$list_profile[slug]";?>" class="language-btn">INA</a>-->
					<!--		<a href="<?php echo "$nama_folder/en/sdm/$slug";?>" class="language-btn active">ENG</a>-->
					<!--	</div>-->
					<!--</li>-->
					
					<li>
						<div class="language-menu">
							<a href="<?php echo "$nama_folder/sdm/$list_profile[slug]";?>" class="language-btn text-12">INDONESIA</a>
							<div class="text-white set-line">|</div>
							<a href="<?php echo "$nama_folder/en/sdm/$slug";?>" class="language-btn text-12 active">ENGLISH</a>
						</div>
					</li>
				</ul>
            ...
            <div class="row mb-5">
                <div class="col-xl-4">
                    <div class="service-details__services-box">
                        <h3 class="service-details__services-title">Human Resources</h3>
                        ...
                        <?php
                            ...
                            while ($list_menu_keberlanjutan = mysql_fetch_array($menu_keberlanjutan))
                            {
                                ...
                                <li><a href="<?php echo "$nama_folder/career";?>" style="text-transform: none;"><?php echo "$list_menu_keberlanjutan[sub_title_english]";?></a></li>
                                <?php
                            ...
                            ?>
                                <li <?php echo $aktif;?>><a href="<?php echo "$nama_website/sdm/$list_menu_keberlanjutan[slug_english]";?>"><?php echo "$list_menu_keberlanjutan[sub_title_english]";?> <?php echo $span;?></a></li>
                             <?php
                             }
