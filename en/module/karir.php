				...
				<ul class="list-unstyled main-menu__contact-list set-m10">
					<li>
						<div class="language-menu">
							<a href="<?php echo "$nama_folder/$list_profile[slug]";?>" class="language-btn text-12">INDONESIA</a>
							<div class="text-white set-line">|</div>
							<a href="<?php echo "$nama_folder/en/$list_profile[slug_english]";?>" class="language-btn text-12 active">ENGLISH</a>
						</div>
					</li>
				</ul>
                    ...
                    <div class="service-details__services-box">
                            ...
                            <ul class="service-details__services-list list-unstyled">
                                ...
                                while ($list_menu_keberlanjutan = mysql_fetch_array($menu_keberlanjutan))
                                {
                                    ...
                                    <li class='active'><a href="<?php echo "$nama_website/career";?>" style="text-transform: none;"><?php echo "$list_menu_keberlanjutan[sub_title_english]";?></a></li>
                                    <?php
                                ...
                                ?>
                                    <li <?php echo $aktif;?>><a href="<?php echo "$nama_website/sdm/$list_menu_keberlanjutan[slug_english]";?>" style="text-transform: none;"><?php echo "$list_menu_keberlanjutan[sub_title_english]";?> <?php echo $span;?></a></li>
                                <?php
                                    }
                                }
                                ?>
                    ...
                    <div class="shop-details-page1__img">
                        ...
                        ?>
                            <div class="col-lg-4 mb-5">
                                <a href="<?php echo "$nama_website/apply/$list_lowongan_kerja[id_lowongan_kerja]/$list_lowongan_kerja[slug_english]";?>">
                                    ...
                                    <img src="<?php echo "$nama_folder/images/post/$list_lowongan_kerja[gambar]";?>" style="width:100%;"> 
                                        ...
                                        <div style="padding:10px;">
                                            <h5 class="ijo bold mb-2"><?php echo "$list_lowongan_kerja[title_english]";?></h5>
                                            <img src="<?php echo "$nama_folder";?>/assets/images/icon/resume1.png" class="width-10p">  Apply
                                        </div>
                                    </div>
                                </a>
                            </div>
