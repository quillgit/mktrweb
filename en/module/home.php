<?php
	...
	<section class="main-slider-three">
		<div class="main-slider-three__carousel owl-carousel owl-theme">
            ...
            $menu_banner = mysql_query("SELECT
                tabel_banner.title_english, 
                tabel_banner.id_banner, 
                tabel_banner.konten_english, 
                tabel_banner.link, 
                tabel_banner.gambar, 
			...
			<div class="item">
				...
				<div class="container">
					<div class="main-slider-three__content">
						...
						<h2 class="main-slider-three__title"><?php echo $list_menu_banner['title_english'];?></h2>
						<p class="main-slider-three__text"><?php echo $list_menu_banner['konten_english'];?></p>
					</div>
				</div>
			</div>
			<?php
			...
			<div class="row">
					...
					<div class="about-one__left wow slideInLeft" data-wow-delay="100ms"
						...
						<div class="row">
							...
							<div class="col-xl-6">
								...
								<!--	<h3><?php echo "$setup_home[sub_title_english]";?></h3>-->
								<!--</div>-->
				...
				<div class="col-xl-6">
					<div class="about-one__right wow fadeInRight" data-wow-delay="300ms">
						...
						<p class="about-one__text-1 mb-4"><?php echo "$setup_home[description_english]";?>
						</p>
						<div class="about-one__btn-box mt-4">
							<a href="<?php echo "$nama_website/profil_kami";?>" class="about-one__btn thm-btn">Read More</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="services-four">
			<div class="container">
				<div class="section-title-three text-center sec-title-animation animation-style1">
					...
					<h2 class="section-title-three__title title-animation">OUR CORE BUSINESSES</h2>
				</div>
				<div class="row">
					<?php
                   $home_bisnis_int = mysql_query("SELECT id_bisnis_inti, sub_title_english, sub_title, slug, slug_english, gambar, konten_english FROM tabel_bisnis_inti");
                   while ($list_home_bisnis_int = mysql_fetch_array($home_bisnis_int))
                   {
						$konten = limitWord($list_home_bisnis_int['description_english'],10);
                   ?>
					<div class="col-xl-3 col-lg-3 wow fadeInUp" data-wow-delay="100ms">
						<div class="services-four__single">
							...
							<div class="services-four__content">
								<h3 class="services-four__title"><a href="<?php echo "$nama_website/bisnis/$list_home_bisnis_int[slug_english]";?>"><?php echo "$list_home_bisnis_int[sub_title_english]";?></a></h3>
								<p class="services-four__text"><?php echo "$list_home_bisnis_int[konten_english]";?> ...
								</p>
		...
		<div class="container">
			<div class="project-one__top">
				<div class="section-title text-left">
					...
					<div class="section-title__title-box sec-title-animation animation-style2">
						<h2 class="section-title__title title-animation">Sustainability</h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-xl-4 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="100ms">
				   ...
				   <?php
                   $home_berkelanjutan_1 = mysql_query("SELECT sub_title, description, sub_title_english, description_english, gambar, slug_english FROM tabel_berkelanjutan WHERE kategori != 'child' AND tipe = 'text' AND id_berkelanjutan != '1' ORDER BY id_berkelanjutan ASC limit 2");
                   while ($list_home_berkelanjutan_1 = mysql_fetch_array($home_berkelanjutan_1))
                   {
						$konten = limitWord($list_home_berkelanjutan_1['description_english'],15);
                   ?>
					...
					<div class="project-one__single">
						<div class="project-one__img-box">
							...
							<div class="project-one__content">
								<h2  class="project-one__sub-title"><?php echo "$list_home_berkelanjutan_1[sub_title_english]";?></h2>
								<p class="project-one__sub-title"><?php echo "$konten";?>... <a href="<?php echo "$nama_website/keberlanjutan/$list_home_berkelanjutan_1[slug_english]";?>">See More</a></p>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-8 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
					...
					<?php
                   	$home_berkelanjutan_2 = mysql_query("SELECT sub_title, description, sub_title_english, description_english, gambar, slug_english FROM tabel_berkelanjutan WHERE kategori != 'child' AND tipe = 'text' AND id_berkelanjutan = '1'");
                   while ($list_home_berkelanjutan_2 = mysql_fetch_array($home_berkelanjutan_2))
                   	{
						$konten = limitWord($list_home_berkelanjutan_2['description_english'],50);
                   	?>
					...
					<div class="project-one__single">
						<div class="project-one__img-box">
							...
							<div class="project-one__content">
								<h2 class="project-one__sub-title"><?php echo "$list_home_berkelanjutan_2[sub_title_english]";?></h2>
								<p class="project-one__sub-title"><?php echo "$konten";?>... <a href="<?php echo "$nama_website/keberlanjutan/$list_home_berkelanjutan_2[slug_english]";?>">See More</a></p>
							</div>
						</div>
					</div>
					...
					<?php
                   	$home_berkelanjutan_3 = mysql_query("SELECT sub_title, description, sub_title_english, description_english, gambar, slug_english FROM tabel_berkelanjutan WHERE id_berkelanjutan = '43'");
                   	while ($list_home_berkelanjutan_3 = mysql_fetch_array($home_berkelanjutan_3))
                   	{
						$konten = limitWord($list_home_berkelanjutan_3['description_english'],10);
                   	?>
						<div class="col-xl-6 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="900ms">
							<div class="project-one__single">
								<div class="project-one__img-box">
									...
									<div class="project-one__content">
										<h2 class="project-one__sub-title"><?php echo "$list_home_berkelanjutan_3[sub_title_english]";?></h2>
										<p class="project-one__sub-title"><?php echo "$konten";?>... <a href="<?php echo "$nama_website/keberlanjutan/$list_home_berkelanjutan_3[slug_english]";?>">See More</a></p>
									</div>
								</div>
							</div>
						</div>
					...
					<?php
                   	$home_berkelanjutan_4 = mysql_query("SELECT sub_title, description, sub_title_english, description_english, gambar, slug_english FROM tabel_berkelanjutan WHERE id_berkelanjutan = '35'");
                   	while ($list_home_berkelanjutan_4 = mysql_fetch_array($home_berkelanjutan_4))
                   	{
						$konten = limitWord($list_home_berkelanjutan_4['description_english'],10);
                   	?>
						<div class="col-xl-6 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="900ms">
							<div class="project-one__single">
								<div class="project-one__img-box">
									...
									<div class="project-one__content">
										<h2 class="project-one__sub-title"><?php echo "$list_home_berkelanjutan_4[sub_title_english]";?></h2>
										<p class="project-one__sub-title"><?php echo "$konten";?>... <a href="<?php echo "$nama_website/keberlanjutan/$list_home_berkelanjutan_4[slug_english]";?>">See More</a></p>
									</div>
								</div>
							</div>
						</div>
	...
	<section class="shop-details-page1">
		<div class="container">
			<div
				...
				<h2 class="section-title__title title-animation">Investor Relations</h2>
			</div>
		...
		<div class="container">
			<div class="blog-one__top">
				<div class="section-title text-left">
					...
					<div class="section-title__title-box sec-title-animation animation-style2">
						<h2 class="section-title__title title-animation">News & Activities</h2>
					</div>
				</div>
				<div class="blog-one__btn-box">
					<a href="<?php echo "$nama_website/news";?>" class="blog-one__btn thm-btn">See All</a>
				</div>
			</div>
			<div class="row">
				<?php
				$berita_other = mysql_query("SELECT title_english, content, gambar, id_berita, slug_english, created FROM tabel_berita where status = '2' AND id_berita != '$id' ORDER BY created DESC limit 3");
					...
					<div class="blog-one__single">
						<div class="blog-one__img-box">
							<div class="blog-one__img">
								<img src="<?php echo "$nama_folder/images/post/$list_berita_other[gambar]";?>" alt="<?php echo "$list_berita_other[title_english]";?>" class="height-img">
								<img src="<?php echo "$nama_folder/images/post/$list_berita_other[gambar]";?>" alt="<?php echo "$list_berita_other[title_english]";?>" class="height-img">
								<a href="<?php echo "$nama_website/read/$list_berita_other[id_berita]/$list_berita_other[slug_english]";?>" class="blog-one__link"><span class="sr-only"></span></a>
							</div>
						...
						<div class="blog-one__content">
							...
							<!--</div>-->
							<h3 class="blog-one__title"><a href="<?php echo "$nama_website/read/$list_berita_other[id_berita]/$list_berita_other[slug_english]";?>"><?php echo "$list_berita_other[title_english]";?> </a></h3>
							<a href="<?php echo "$nama_website/read/$list_berita_other[id_berita]/$list_berita_other[slug_english]";?>" class="blog-one__learn-more">Read More<span class="icon-arrow-right"></span></a>
						</div>
					</div>
				</div>
				<?php
	...
	<a href="<?php echo "$nama_website/keberlanjutan/daftar-pengaduan";?>">
		<img src="<?php echo "$nama_folder";?>/assets/images/resources/bicara2.png" class="posisi-bicara">
	</a>
