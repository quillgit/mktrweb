            ...
            <div class="main-menu__top">
                <div class="main-menu__top-inner">
                    <ul class="list-unstyled main-menu__contact-list set-m10">
                        ...
                        <!--        <a href="<?php echo "$nama_folder/berita";?>" class="language-btn">INA</a>-->
                        <!--        <a href="<?php echo "$nama_website/news";?>" class="language-btn active ">ENG</a>-->
                        <!--    </div>-->
                        <!--</li>-->
                        
                        <li>
    						<div class="language-menu">
    							<a href="<?php echo "$nama_folder/berita";?>" class="language-btn text-12">INDONESIA</a>
    							<div class="text-white set-line">|</div>
    							<a href="<?php echo "$nama_website/news";?>" class="language-btn text-12 active">ENGLISH</a>
    						</div>
    					</li>
                    </ul>
        ...
        <section class="blog-page">
            <div class="container">
                ...
                while ($list_berita = mysql_fetch_array($berita))
                {
                    ...
                    $judul = limitWord($list_berita['title_english'],8);
                        ...
                        <div class="blog-one__single">
                            <div class="blog-one__img-box">
                                <div class="blog-one__img">
                                    ...
                                    <img src="<?php echo "$nama_folder/images/post/$list_berita[gambar]";?>" alt="<?php echo "$list_berita[title]";?>">
                                    <a href="<?php echo "$nama_website/read/$list_berita[id_berita]/$list_berita[slug_english]";?>" class="blog-one__link"><span class="sr-only"></span></a>
                                </div>
                            ...
                            <div class="blog-one__content">
                                <h3 class="blog-one__title"><a href="<?php echo "$nama_website/read/$list_berita[id_berita]/$list_berita[slug_english]";?>"><?php echo "$list_berita[title_english]";?></a></h3>
                                <a href="<?php echo "$nama_website/read/$list_berita[id_berita]/$list_berita[slug_english]";?>" class="blog-one__learn-more">Read More<span class="icon-arrow-right"></span></a>
                            </div>
                        </div>
                    </div>
                <?php
