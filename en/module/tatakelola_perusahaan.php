<?php
    ...
    $profile = mysql_query("SELECT sub_title, description, sub_title_english, description_english, gambar, tipe, id_tatakelola_perusahaan, banner, slug, banner_mobile FROM tabel_tatakelola_perusahaan WHERE slug_english = '$slug'");
				...
				<ul class="list-unstyled main-menu__contact-list set-m10">
					<li>
						<div class="language-menu">
							<a href="<?php echo "$nama_folder/tatakelola_perusahaan/$list_profile[slug]";?>" class="language-btn text-12">INDONESIA</a>
							<div class="text-white set-line">|</div>
							<a href="<?php echo "$nama_folder/en/tatakelola_perusahaan/$slug";?>" class="language-btn text-12 active">ENGLISH</a>
						</div>
					</li>
				</ul>
            ...
            <div class="row mb-5">
                <div class="col-xl-4">
                    <div class="service-details__services-box">
                        <h3 class="service-details__services-title">Corporate governance</h3>
                        ...
                        if($list_profile['kategori'] != 'child'){
                            ...
                            ?>
                            <li <?php echo $aktif;?>><a href="<?php echo "$nama_website/tatakelola_perusahaan/$list_menu_keberlanjutan[slug_english]";?>"><?php echo "$list_menu_keberlanjutan[sub_title_english]";?> <?php echo $span;?></a></li>
                            <?php
                             if($list_menu_keberlanjutan['id_tatakelola_perusahaan'] == $list_profile['id_tatakelola_perusahaan']){
                                 ...
                                 {
                                 ?>  
                                 <li><a href="<?php echo "$nama_website/tatakelola_perusahaan/$list_menu_keberlanjutan_child[slug_english]";?>"><?php echo $list_menu_keberlanjutan_child['sub_title_english'];?></a></li>
                             <?php
                                 }
                             }
                             ?>
                        ...
                        ?>
                            <li <?php echo $aktif;?>><a href="<?php echo "$nama_website/tatakelola_perusahaan/$menu_keberlanjutan_parent2[slug_english]";?>"><?php echo "$menu_keberlanjutan_parent2[sub_title_english]";?> <span class='icon-angle-right'></span></a></li>
                        ...
                        <?php
                            ...
                            ?>
                            <li <?php echo $aktif;?>><a href="<?php echo "$nama_website/tatakelola_perusahaan/$list_menu_keberlanjutan[slug]";?>"><?php echo "$list_menu_keberlanjutan[sub_title_english]";?> <?php echo $span;?></a></li>
