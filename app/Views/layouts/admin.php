...
<div class="a-shell">
  <aside class="a-side">
    ...
    <nav class="a-side__nav" aria-label="Navigasi CMS">
      ...
      <a class="a-side__link<?= $isActive('/admin') && !$isActive('/admin/posts') && !$isActive('/admin/media') ? ' is-active' : '' ?>"
      ...
      <a class="a-side__link" href="#" aria-disabled="true" style="opacity:.45;cursor:not-allowed">Dokumen Investor</a>
