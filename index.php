...
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
    ...
    <head>
        ...
        $news_judul = $list_profile['sub_title'];
    	...
    	<meta property="og:url" content="<?php echo "$nama_folder/profil_kami"; ?>"/>
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/logo_kami"; ?>"/>
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/visi_misi"; ?>"/>
    	...
    	<title>Peristiwa Penting - PT. Menthobi Karyatama Raya Tbk (MKTR) </title>
        <meta name="author" content="PT. Menthobi Karyatama Raya Tbk (MKTR) ">
    	
    	<meta property="og:type" content="companyprofile "/>
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="Peristiwa Penting"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/peristiwa_penting"; ?>"/>
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/struktur_kepemilikan"; ?>"/>
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/struktur_organisasi"; ?>"/>
    	...
    	<title>Dewan Komisaris - PT. Menthobi Karyatama Raya Tbk (MKTR) </title>
        <meta name="author" content="PT. Menthobi Karyatama Raya Tbk (MKTR) ">
    	
    	<meta property="og:type" content="companyprofile "/>
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="Dewan Komisaris"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/dewan_komisaris"; ?>"/>
    	...
    	<title>Direksi - PT. Menthobi Karyatama Raya Tbk (MKTR) </title>
        <meta name="author" content="PT. Menthobi Karyatama Raya Tbk (MKTR) ">
    	
    	<meta property="og:type" content="companyprofile "/>
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="Direksi"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/direksi"; ?>"/>
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/mktr_so/$slug_seo"; ?>"/>
    	...
    	<title>Anak Perusahaan Kami - PT. Menthobi Karyatama Raya Tbk (MKTR) </title>
        <meta name="author" content="PT. Menthobi Karyatama Raya Tbk (MKTR) ">
    	
    	<meta property="og:type" content="companyprofile "/>
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="Anak Perusahaan - PT. Menthobi Karyatama Raya Tbk (MKTR) "/>
    	<meta property="og:url" content="<?php echo "$nama_folder/anak_perusahaan_kami"; ?>"/>
    	...
    	<title>Penghargaan & Pengakuan - PT. Menthobi Karyatama Raya Tbk (MKTR) </title>
        <meta name="author" content="PT. Menthobi Karyatama Raya Tbk (MKTR) ">
    	
    	<meta property="og:type" content="companyprofile "/>
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="Penghargaan & Pengakuan - PT. Menthobi Karyatama Raya Tbk (MKTR) "/>
    	<meta property="og:url" content="<?php echo "$nama_folder/anak_perusahaan_kami"; ?>"/>
    	   
        <meta name="author" content="PT. Menthobi Karyatama Raya Tbk (MKTR) ">
        <meta name="description" content="Penghargaan & Pengakuan PROPER EMAS 2024 &GREEN LEADERSHIP UTAMA, TrenAsia ESG Award - Agribusiness Sustainability">
        <meta property="og:description" content="Penghargaan & Pengakuan PROPER EMAS 2024 &GREEN LEADERSHIP UTAMA, TrenAsia ESG Award - Agribusiness Sustainability"/>
        <meta name="keywords" content="Penghargaan & Pengakuan MKTR, PROPER EMAS 2024 &GREEN LEADERSHIP UTAMA, TrenAsia ESG Award - Agribusiness Sustainability" itemprop="keywords">
    	...
    	<title>Keanggotaan - PT. Menthobi Karyatama Raya Tbk (MKTR) </title>
        <meta name="author" content="PT. Menthobi Karyatama Raya Tbk (MKTR) ">
    	
    	<meta property="og:type" content="companyprofile "/>
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="Keanggotaan - PT. Menthobi Karyatama Raya Tbk (MKTR) "/>
    	<meta property="og:url" content="<?php echo "$nama_folder/keanggotaan"; ?>"/>
    	   
        <meta name="author" content="PT. Menthobi Karyatama Raya Tbk (MKTR) ">
        <meta name="description" content="PT. Menthobi Karyatama Raya Tbk (MKTR) Keanggotaan : Gabungan Pengusaha Kelapa Sawit Indonesia (GAPKI), Kamar Dagang dan Industri Indonesia (KADIN), Indonesia Corporate Secretary Association (ICSA)">
        <meta property="og:description" content="PT. Menthobi Karyatama Raya Tbk (MKTR) Keanggotaan : Gabungan Pengusaha Kelapa Sawit Indonesia (GAPKI), Kamar Dagang dan Industri Indonesia (KADIN), Indonesia Corporate Secretary Association (ICSA)"/>
        ...
        $artikel_detail_seo = mysql_fetch_array(mysql_query("SELECT title, sub_title, sub_title_english, gambar FROM tabel_bisnis_inti WHERE slug = '$slug_seo'"));
    
        $news_judul = $artikel_detail_seo['sub_title'];
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/bisnis/$slug_seo"; ?>"/>
        ...
        $artikel_detail_seo = mysql_fetch_array(mysql_query("SELECT title, sub_title, sub_title_english, description_english, description, gambar FROM tabel_berkelanjutan WHERE slug = '$slug_seo'"));
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/keberlanjutan/$slug_seo"; ?>"/>
        ...
        $artikel_detail_seo = mysql_fetch_array(mysql_query("SELECT title, sub_title, sub_title_english, description_english, description, gambar FROM tabel_tatakelola_perusahaan WHERE slug = '$slug_seo'"));
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/tatakelola_perusahaan/$slug_seo"; ?>"/>
        ...
        $artikel_detail_seo = mysql_fetch_array(mysql_query("SELECT title, sub_title, sub_title_english, description_english, description, gambar FROM tabel_tentang_kami WHERE slug = '$slug_seo'"));
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/hubungan_investor/$slug_seo"; ?>"/>
        ...
        $artikel_detail_seo = mysql_fetch_array(mysql_query("SELECT title, sub_title, sub_title_english, description_english, description FROM tabel_sumber_daya WHERE slug = '$slug_seo'"));
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/sdm/$slug_seo"; ?>"/>
        ...
        $artikel_detail_seo = mysql_fetch_array(mysql_query("SELECT title, meta_keyword, meta_description, gambar FROM tabel_berita where id_berita = '$id_seo' AND slug = '$slug_seo'"));
    	...
    	<meta property="og:site_name" content="mktr.co.id"/>
    	<meta property="og:title" content="<?php echo "$news_judul"; ?>"/>
    	<meta property="og:url" content="<?php echo "$nama_folder/read/$id_seo/$slug_seo"; ?>"/>
		...
		$news_judul = "Berita & Kegiatan";
        $deskripsionon = "Berita & Kegiatan - PT. Menthobi Karyatama Raya Tbk (MKTR)";
        $keywordd = "Berita Sawit, Berita Logistik dan Alat Berat, Berita MKTR, Berita Maktour";
        ?>
    
        <title>Berita & Kegiatan - PT. Menthobi Karyatama Raya Tbk (MKTR) </title>
        <meta name="author" content="PT. Menthobi Karyatama Raya Tbk (MKTR) ">
        ...
        <title>Pelaporan Pelanggaran - PT. Menthobi Karyatama Raya Tbk (MKTR) </title>
        <meta name="author" content="PT. Menthobi Karyatama Raya Tbk (MKTR) ">
        <meta name="description" content="PT. Menthobi Karyatama Raya Tbk ( MKTR ) merupakan perusahaan perkebunan yang berpusat di Jakarta. MKTR adalah bagian dari Maktour Group, perusahaan biro haji dan umroh terkemuka di Indonesia yang dipimpin oleh Fuad Hasan Masyhur.">
        <meta property="og:description" content="PT. Menthobi Karyatama Raya Tbk ( MKTR ) merupakan perusahaan perkebunan yang berpusat di Jakarta. MKTR adalah bagian dari Maktour Group, perusahaan biro haji dan umroh terkemuka di Indonesia yang dipimpin oleh Fuad Hasan Masyhur."/>
        <meta name="keywords" content="PT. Menthobi Karyatama Raya Tbk, MKTR, Maktour Group" itemprop="keywords">
        ...
        <link rel="stylesheet" href="<?php echo "$nama_folder";?>/assets/css/module-css/service.css?v=<?=time()?>" />
        ...
        <link rel="stylesheet" href="<?php echo "$nama_folder";?>/assets/css/module-css/coming-soon.css" />
						...
						<div class="row">
							<div class="col-xl-2 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
								<div class="footer-widget__column footer-widget__usefull-link">
									<div class="footer-widget__title-box">
										<h3 class="footer-widget__title">Tentang Kami</h3>
									</div>
								...
								<div class="footer-widget__column footer-widget__usefull-link mt-5">
									<div class="footer-widget__title-box">
										<h3 class="footer-widget__title">Hubungan Investor</h3>
									</div>
									<div class="footer-widget__link-box">
										<ul class="footer-widget__link list-unstyled">
										<?php
                                        ...
                                        {
                                        ?> 
											<li><a href="<?php echo "$nama_folder/hubungan_investor/$list_menu_hi_footer[slug]";?>"><?php echo $list_menu_hi_footer['sub_title'];?></a></li>
										<?php
										}
										?>
										</ul>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
								<div class="footer-widget__column footer-widget__services">
									<div class="footer-widget__title-box">
										<h3 class="footer-widget__title">Bisnis Inti</h3>
									</div>
									<ul class="footer-widget__link list-unstyled">
										<?php
                                        ...
                                        {
                                        ?>
                                        <li><a href="<?php echo "$nama_folder/bisnis/$list_footer_menu_bisnis_int[slug]";?>"><?php echo $list_footer_menu_bisnis_int['sub_title'];?></a></li>
                                        <?php
                                        }
                                        ?>
									</ul>
								...
								<div class="footer-widget__column footer-widget__services mt-5">
									<div class="footer-widget__title-box">
										<h3 class="footer-widget__title">Sumber daya Manusia</h3>
									</div>
									<ul class="footer-widget__link list-unstyled">
										<?php
										...
										{
                                        ?> 
											<li><a href="<?php echo "$nama_folder/sdm/$list_menu_sdm_footer[slug]";?>"><?php echo $list_menu_sdm_footer['sub_title'];?></a></li>
										<?php
										}
										?>
									</ul>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp " data-wow-delay="400ms">
								<div class="footer-widget__column footer-widget__contact">
									<div class="footer-widget__title-box">
										<h3 class="footer-widget__title">Keberlanjutan</h3>
									</div>
									<ul class="footer-widget__link list-unstyled mb-3">
										...
										{
                                        ?> 
										<li><a href="<?php echo "$nama_folder/keberlanjutan/$list_menu_keberlanjutan_footer[slug]";?>"><?php echo $list_menu_keberlanjutan_footer['sub_title'];?></a></li>
										<?php
										}
										?>
									</ul>
							...
							<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
								<div class="footer-widget__column footer-widget__contact mt-1m">
									<div class="footer-widget__title-box">
										<h3 class="footer-widget__title">Tata Kelola Perusahaan</h3>
									</div>
									<ul class="footer-widget__link list-unstyled">
										<?php
                                        ...
                                        {
                                        ?> 
										<li><a href="<?php echo "$nama_folder/tatakelola_perusahaan/$list_menu_keberlanjutan1_footer[slug]";?>"><?php echo $list_menu_keberlanjutan1_footer['sub_title'];?></a></li>
										<?php
										}
										?>
									</ul>
					...
					<div class="container">
						...
						<div class="site-footer__bottom-inner">
                            <div class="main-menu__top-right">
                                ...
                                <div class="set-m20">
                                    <a href="<?php echo "$nama_folder/pelaporan_pelanggaran"; ?>" class="text-white ">Pelaporan Pelanggaran</a>
                                </div>
                            </div>
	...
	<div class="mobile-nav__wrapper">
		...
		<div class="mobile-nav__content">
			...
			<div class="logo-box">
				<a href="<?php echo "$nama_folder";?>" aria-label="logo image">
	...
	<script src="<?php echo "$nama_folder";?>/assets/js/fslightbox.js"></script>
