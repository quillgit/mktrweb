<?php
    ...
    $profile = mysql_query("SELECT title, sub_title, description, sub_title_english, description_english, gambar, banner, slug_english, banner_mobile FROM tabel_bisnis_inti WHERE slug = '$slug'");
				...
				<ul class="list-unstyled main-menu__contact-list set-m10">
					<li>
						<div class="language-menu">
                            <a href="<?php echo "$nama_folder/bisnis/$slug";?>" class="language-btn active text-12">INDONESIA</a>
                            <div class="text-white set-line">|</div>
                            <a href="<?php echo "$nama_folder/en/bisnis/$list_profile[slug_english]";?>" class="language-btn text-12">ENGLISH</a>
                        </div>
					</li>
				</ul>
            ...
            <div class="row mb-5">
                <div class="col-xl-4">
                    <div class="service-details__services-box">
                        <h3 class="service-details__services-title">Bisnis Inti</h3>
                        <ul class="service-details__services-list list-unstyled">
                            ...
                            {
                                if($slug == $list_menu_bisnis_int['slug']){
                                    $aktif = "class='active'";
                                }else{
                                    $aktif = "";
                                }
                            ?>
                            <li <?php echo $aktif;?>><a href="<?php echo "$nama_folder/bisnis/$list_menu_bisnis_int[slug]";?>"><?php echo "$list_menu_bisnis_int[sub_title]";?></a></li>
                            <?php
                            }
                            ?>
                        </ul>
