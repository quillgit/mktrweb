				...
				<ul class="list-unstyled main-menu__contact-list set-m10">
					<li>
						<div class="language-menu">
                            <a href="<?php echo "$nama_folder/struktur_kepemilikan";?>" class="language-btn active text-12">INDONESIA</a>
                            <div class="text-white set-line">|</div>
                            <a href="<?php echo "$nama_folder/en/struktur_kepemilikan";?>" class="language-btn text-12">ENGLISH</a>
                        </div>
					</li>
				</ul>
                ...
                <div class="col-xl-4">
                    <div class="service-details__services-box">
                        ...
                        <ul class="service-details__services-list list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo "$nama_folder/struktur_kepemilikan";?>">Struktur Kepemilikan </a></li>
