<?php
    ...
    $profile = mysql_query("SELECT id_lowongan_kerja, title_english, title, slug, slug_english, content, content_english, gambar FROM tabel_lowongan_kerja WHERE slug = '$slug' AND id_lowongan_kerja = '$id_lowongan_kerja'");
				...
				<ul class="list-unstyled main-menu__contact-list set-m10">
					<li>
						<div class="language-menu">
							<a href="<?php echo "$nama_folder/apply/$id_lowongan_kerja/$list_profile[slug]";?>" class="language-btn text-12 active">INDONESIA</a>
							<div class="text-white set-line">|</div>
							<a href="<?php echo "$nama_folder/en/apply/$id_lowongan_kerja/$list_profile[slug_english]";?>" class="language-btn text-12 ">ENGLISH</a>
						</div>
					</li>
				</ul>
            ...
            <div class="page-header__inner">
                ...
                <div class="thm-breadcrumb__inner">
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li><span class="icon-angle-right"></span></li>
                        <li><?php echo "$list_profile[title]";?></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row mb-5">
                ...
                <div class="col-xl-8">
                            <div class="shop-details-page1__title">
                                <h2 id="item-title"><?php echo "$list_profile[title]";?></h2>
                            </div>
