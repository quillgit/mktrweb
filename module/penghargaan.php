				...
				<ul class="list-unstyled main-menu__contact-list set-m10">
					<li>
						<div class="language-menu">
                            <a href="<?php echo "$nama_folder/penghargaan";?>" class="language-btn active text-12">INDONESIA</a>
                            <div class="text-white set-line">|</div>
                            <a href="<?php echo "$nama_folder/en/penghargaan";?>" class="language-btn text-12">ENGLISH</a>
                        </div>
					</li>
				</ul>
                ...
                <div class="col-xl-4">
                    <div class="service-details__services-box">
                        ...
                        <ul class="service-details__services-list list-unstyled">
                            ...
                            <li class="active"><a href="<?php echo "$nama_folder/penghargaan";?>">Penghargaan & Pengakuan</a></li>
                                    ...
                                    <div class="col-xl-7">
                                        <div class="shop-details-page1__content">
                                            <div class="shop-details-page1__title">
                                                <h6>Penghargaan & Pengakuan</h6>
                                                <h2><?php echo "$list_penghargaan[title]";?>
                                                </h2>
                                            </div>
                                            <div class="shop-details-page1__text">
                                                <?php echo "$list_penghargaan[content]";?>
                                            </div>
                                        </div>
                                    </div>
