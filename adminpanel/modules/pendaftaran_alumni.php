                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            ...
                                            <div class="form-label-group">
												<input type="text" class="form-control" value="<?php echo"$detail[nick_name]"; ?>" readonly="readonly"/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
											<h6>Tahun TK</h6>
						...
						<form id="submitFilter">
							<div class="form-row">
								<div class="form-group col-md-2">
									<label for="valueSelectFilter">Tipe Filter</label>
								...
								<div class="form-group col-md-4">
									<label for="valueFilterTahun">Value (Tahun Lulus/Gol.Darah)</label>
									<input type="text" value="" id="valueFilterTahun" class="form-control" placeholder="">
								</div>
