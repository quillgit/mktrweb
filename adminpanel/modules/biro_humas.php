                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Biro Humas</h4>
                        </div>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <a href="admin.php?menu=biro_humas" class="btn btn-outline-warning mr-1 mb-1">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-left mb-0">Biro Humas</h2>
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">Data Biro Humas
								</li>
							</ol>
						</div>
					</div>
				...
				<div class="table-responsive">
					<table class="table data-thumb-view" id="table-product">
						...
						<tbody id="product-list">
							<?php
							$no = 1;
							$banner = mysql_query("SELECT * FROM tabel_about_us where id_about_us = '3'");
	...
	elseif ($_GET['mod']=='edit')
	{
		...
		elseif ($_GET['act']=='process')
		{
			...
			if ($query)
			{
				...
				echo "<script>alert('Data Berhasil di Update');window.location=('admin.php?menu=biro_humas')</script>";
