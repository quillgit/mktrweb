                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <a href="admin.php?menu=prospektus" class="btn btn-outline-warning mr-1 mb-1">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
					...
					<div class="col-12">
						...
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">Data Prospektus
								</li>
							</ol>
						</div>
					</div>
		...
		elseif ($_GET['act']=='process')
		{
			...
			if ($query)
			{
				...
				*/
				...
				echo "<script>alert('Data Berhasil di Update');window.location=('admin.php?menu=prospektus')</script>";
