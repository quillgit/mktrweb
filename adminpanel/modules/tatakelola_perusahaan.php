<?php
	function form(){
		...
		if 	(($_GET['mod']=='edit'))
		{
			...
			$edit = mysql_fetch_array(mysql_query("SELECT * FROM tabel_tatakelola_perusahaan WHERE id_tatakelola_perusahaan = '$id'"));
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Tatakelola Perusahaan</h4>
                        </div>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <a href="admin.php?menu=tatakelola_perusahaan" class="btn btn-outline-warning mr-1 mb-1">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-left mb-0">Tatakelola Perusahaan</h2>
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="admin.php?menu=home">Home</a>
								</li>
								<li class="breadcrumb-item"><a href="#">Tatakelola Perusahaan</a>
								</li>
								<li class="breadcrumb-item active">Data Tatakelola Perusahaan
								</li>
							</ol>
						</div>
					</div>
				...
				<div class="table-responsive">
					<table class="table data-thumb-view" id="table-product">
						...
						<tbody id="product-list">
							<?php
							$no = 1;
							$banner = mysql_query("SELECT * FROM tabel_tatakelola_perusahaan");
							...
							<tr>
								...
								<td>$list[updated]</td>
								<td>$status</td>
								<td align='center'><a href='?menu=$_GET[menu]&mod=edit&id=$list[id_tatakelola_perusahaan]'><img src=img/edit.png border=0 /></a> ";
							?>
								</td>
							</tr>
							<?php
	...
	elseif ($_GET['mod']=='edit')
	{
		...
		elseif ($_GET['act']=='process')
		{
			...
			$update = "UPDATE tabel_tatakelola_perusahaan SET  title = '$title',
													sub_title = '$sub_title',
												...
												WHERE id_tatakelola_perusahaan = '$_POST[id]'";
			...
			if ($query)
			{
				...
				if (!empty($lok_mobile)){
					...
					if($ft_mobile=="image/jpeg" || $ft_mobile=="image/jpg" || $ft_mobile=="image/png" || $ft_mobile=="image/gif"){
						...
						$gbr = mysql_fetch_array (mysql_query("SELECT * FROM tabel_tatakelola_perusahaan WHERE id_tatakelola_perusahaan = '$_POST[id]'"));
						if (!empty($gbr['banner'])) 
						{
							if (file_exists("../images/banner/$gbr[banner]"))
							{unlink("../images/banner/$gbr[banner]");}
						}
						mysql_query("UPDATE tabel_tatakelola_perusahaan SET banner = '$fn_mobile_fin' WHERE id_tatakelola_perusahaan = '$_POST[id]'");	
					}
				...
				if (!empty($lok_banner_mobile)){
					...
					if($ft_banner_mobile=="image/jpeg" || $ft_banner_mobile=="image/jpg" || $ft_banner_mobile=="image/png" || $ft_banner_mobile=="image/gif"){
						...
						mysql_query("UPDATE tabel_tatakelola_perusahaan SET banner_mobile = '$fn_banner_mobile_fin' WHERE id_tatakelola_perusahaan = '$_POST[id]'");	
					}
					
				}
				
				echo "<script>alert('Data Berhasil di Update');window.location=('admin.php?menu=tatakelola_perusahaan')</script>";
