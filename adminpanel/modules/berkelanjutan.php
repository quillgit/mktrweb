<?php
	function form(){
		...
		if 	(($_GET['mod']=='edit'))
		{
			...
			$edit = mysql_fetch_array(mysql_query("SELECT * FROM tabel_berkelanjutan WHERE id_berkelanjutan = '$id'"));
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <a href="admin.php?menu=berkelanjutan" class="btn btn-outline-warning mr-1 mb-1">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
	...
	?>
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-left mb-0">Berkelanjutan</h2>
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="admin.php?menu=home">Home</a>
								</li>
								<li class="breadcrumb-item"><a href="#">Berkelanjutan</a>
								</li>
								<li class="breadcrumb-item active">Data Berkelanjutan
								</li>
							</ol>
						</div>
					</div>
		...
		<script type="text/javascript" src="assets/js/menu/data-table-berkelanjutan.js"></script>
		<!-- Javascript load  -->
	...
	elseif ($_GET['mod']=='edit')
	{
		...
		elseif ($_GET['act']=='process')
		{
			...
			$update = "UPDATE tabel_berkelanjutan SET  title = '$title',
													sub_title = '$sub_title',
												...
												WHERE id_berkelanjutan = '$_POST[id]'";
			...
			if ($query)
			{
				...
				if (!empty($lokasifile)){
					...
					if($jenis_gambar=="image/jpeg" || $jenis_gambar=="image/jpg" || $jenis_gambar=="image/png" || $jenis_gambar=="image/gif"){
						...
						$gbr = mysql_fetch_array (mysql_query("SELECT * FROM tabel_berkelanjutan WHERE id_berkelanjutan = '$_POST[id]'"));
						if (!empty($gbr['gambar'])) 
						{
							if (file_exists("../images/about/$gbr[gambar]"))
							{unlink("../images/about/$gbr[gambar]");}
						}
						mysql_query("UPDATE tabel_berkelanjutan SET gambar = '$nama_file_baru' WHERE id_berkelanjutan = '$_POST[id]'");	
					}
				...
				if (!empty($lok_mobile)){
					...
					if($ft_mobile=="image/jpeg" || $ft_mobile=="image/jpg" || $ft_mobile=="image/png" || $ft_mobile=="image/gif"){
						...
						mysql_query("UPDATE tabel_berkelanjutan SET banner = '$fn_mobile_fin' WHERE id_berkelanjutan = '$_POST[id]'");	
					}
				...
				if (!empty($lok_banner_mobile)){
					...
					if($ft_banner_mobile=="image/jpeg" || $ft_banner_mobile=="image/jpg" || $ft_banner_mobile=="image/png" || $ft_banner_mobile=="image/gif"){
						...
						mysql_query("UPDATE tabel_berkelanjutan SET banner_mobile = '$fn_banner_mobile_fin' WHERE id_berkelanjutan = '$_POST[id]'");	
					}
					
				}
				
				echo "<script>alert('Data Berhasil di Update');window.location=('admin.php?menu=berkelanjutan')</script>";
